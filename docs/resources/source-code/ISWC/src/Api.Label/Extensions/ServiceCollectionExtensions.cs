...
namespace SpanishPoint.Azure.Iswc.Api.Label
{
    ...
    internal static class ServiceCollectionExtensions
    {
        ...
        {
            services
                .AddScoped<IISWC_Label_SubmissionController, LabelSubmissionController>();
        ...
        public static IServiceCollection AddApiAuthentication(this IServiceCollection services, IConfiguration configuration, IWebHostEnvironment environment)
        {
            ...
            services.AddAuthentication(JwtBearerDefaults.AuthenticationScheme)
                ...
                {
                    options.Authority = configuration["BaseAddress-IswcApiLabel"];
