...
namespace SpanishPoint.Azure.Iswc.PipelineComponents.MetadataStandardizationValidator.Tests.Rules
{
    ...
    public class MD_17Tests : TestBase
    {
        ...
        /// </summary>
        [Fact]
        public async void MD_17_Submission_TrueParam()
        {
        ...
        /// </summary>
        [Fact]
        public async void MD_17_Submission_TrueParam_NoIpsAdded()
        {
        ...
        /// </summary>
        [Fact]
        public async void MD_17_Submission_TrueParam_NotAuthAndEligible()
        {
            var submission = new Submission() { Model = new SubmissionModel() { Agency = "80" } };
            var interestedPartyManagerMock = new Mock<IInterestedPartyManager>();
            var rulesManagerMock = new Mock<IRulesManager>();
        ...
        /// </summary>
        [Fact]
        public async void MD_17_Submission_TrueParam_AuthAndEligible()
        {
            var submission = new Submission() { Model = new SubmissionModel() { Agency = "80" } };
            var interestedPartyManagerMock = new Mock<IInterestedPartyManager>();
            var rulesManagerMock = new Mock<IRulesManager>();
        ...
        /// </summary>
        [Fact]
        public async void MD_17_Submission_FalseParam()
        {
            var submission = new Submission() { Model = new SubmissionModel() };
            var interestedPartyManagerMock = new Mock<IInterestedPartyManager>();
            var rulesManagerMock = new Mock<IRulesManager>();
        ...
        /// </summary>
        [Fact]
        public async void MD_17_Submission_TrueParam_NoIps()
        {
            var submission = new Submission() { Model = new SubmissionModel() };
            var interestedPartyManagerMock = new Mock<IInterestedPartyManager>();
            var rulesManagerMock = new Mock<IRulesManager>();
