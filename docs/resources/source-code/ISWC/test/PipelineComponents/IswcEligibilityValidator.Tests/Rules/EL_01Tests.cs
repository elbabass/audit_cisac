...
namespace SpanishPoint.Azure.Iswc.PipelineComponents.IswcEligibilityValidator.Tests.Rules
{
    ...
    public class EL_01Tests
    {
        ...
        /// </summary>
        [Fact]
        public async void EL_01_EligibleOneIpRepresentedBySubmitter()
        {
        ...
        /// </summary>
        [Fact]
        public async void EL_01_EligibleOneIPRepresentedBySubmitterRoleTypeIneligible()
        {
            var submission = new Submission() { Model = new SubmissionModel() };
            var rulesManagerMock = new Mock<IRulesManager>();
            var agreementManagerMock = new Mock<IAgreementManager>();
        ...
        /// </summary>
        [Fact]
        public async void EL_01_Ineligible()
        {
            var submission = new Submission() { Model = new SubmissionModel() };
            var rulesManagerMock = new Mock<IRulesManager>();
            var agreementManagerMock = new Mock<IAgreementManager>();
        ...
        /// </summary>
        [Fact]
        public async void EL_01_EligibleAllIPBaseNumbersPDAndEligibleRoles()
        {
            var submission = new Submission() { Model = new SubmissionModel() };
            var rulesManagerMock = new Mock<IRulesManager>();
            var agreementManagerMock = new Mock<IAgreementManager>();
        ...
        /// </summary>
        [Fact]
        public async void EL_01_InEligibleNotAllIPBaseNumbersPDAndEligibleRoles()
        {
            var submission = new Submission() { Model = new SubmissionModel() };
            var rulesManagerMock = new Mock<IRulesManager>();
            var agreementManagerMock = new Mock<IAgreementManager>();
        ...
        /// </summary>
        [Fact]
        public async void EL_01_InEligibleNotAllIPBaseNumbersPD()
        {
            var submission = new Submission() { Model = new SubmissionModel() };
            var rulesManagerMock = new Mock<IRulesManager>();
            var agreementManagerMock = new Mock<IAgreementManager>();
        ...
        /// </summary>
        [Fact]
        public async void EL_01_EligibleOneIpRepresentedBySubmitterChildAgency()
        {
            var submission = new Submission() { Model = new SubmissionModel() };
            var rulesManagerMock = new Mock<IRulesManager>();
            var agreementManagerMock = new Mock<IAgreementManager>();
