...
namespace SpanishPoint.Azure.Iswc.PipelineComponents.IswcEligibilityValidator.Tests.Rules
{
    ...
    public class EL_04Tests : TestBase
    {
        ...
        /// </summary>
        [Fact]
        public async void EL_04_PublisherRepresentedBySubmitter_Valid()
        {
        ...
        /// </summary>
        [Fact]
        public async void EL_04_PublisherNotRepresentedBySubmitter_InValid()
        {
            var submission = new Submission()
            {
                Model = new SubmissionModel()
        ...
        /// </summary>
        [Fact]
        public async void EL_04_NoAdditionalIdentifierProvided_Valid()
        {
            var submission = new Submission
            {
        ...
        /// </summary>
        [Fact]
        public async void EL_04_InterestedPartyDoesNotExist_Invalid()
        {
            var submission = new Submission
            {
                Model = new SubmissionModel()
        ...
        /// </summary>
        [Fact]
        public async void EL_04_Publisher_IsEligible_to_submit_for_agency_valid()
        {
            var submission = new Submission
            {
                Model = new SubmissionModel()
