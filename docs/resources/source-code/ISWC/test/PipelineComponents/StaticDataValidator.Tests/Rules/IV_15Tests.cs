...
namespace SpanishPoint.Azure.Iswc.PipelineComponents.StaticDataValidator.Tests.Rules
{
    ...
    public class IV_15Tests : TestBase
    {
        ...
        /// </summary>
        [Fact]
        public async void IV_15_Submission_InValid()
        {
        ...
        /// </summary>
        [Fact]
        public async void IV_15_Submission_IswcFormat_InValid()
        {
			var rulesManagerMock = new Mock<IRulesManager>();
            var submission = new Submission() { Model = new SubmissionModel() };
        ...
        /// </summary>
        [Fact]
        public async void IV_15_Submission_Valid()
        {
			var rulesManagerMock = new Mock<IRulesManager>();
            var submission = new Submission() { Model = new SubmissionModel() };
        ...
        /// </summary>
        [Fact]
        public async void IV_15_Submission_Valid_Rule()
        {
            var rulesManagerMock = new Mock<IRulesManager>();
            var submission = new Submission() { Model = new SubmissionModel() };
        ...
        /// </summary>
        [Fact]
        public async void IV_15_Submission_Preferred_IswcFormat_InValid()
        {
            var rulesManagerMock = new Mock<IRulesManager>();
            var submission = new Submission() { Model = new SubmissionModel() };
        ...
        /// </summary>
        [Fact]
        public async void IV_15_Submission_InValid_PreferredISWC()
        {
            var rulesManagerMock = new Mock<IRulesManager>();
            var submission = new Submission() { Model = new SubmissionModel() };
