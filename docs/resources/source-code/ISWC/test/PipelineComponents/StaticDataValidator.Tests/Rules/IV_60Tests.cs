...
namespace SpanishPoint.Azure.Iswc.PipelineComponents.StaticDataValidator.Tests.Rules
{
    ...
    public class IV_60Tests : TestBase
    {
        ...
        /// </summary>
        [Fact]
        public async void IV_60_IpNameAndLastNameAreNull_InValid()
        {
        ...
        /// </summary>
        [Fact]
        public async void IV_60_IpNameIsNull_InValid()
        {
            var rulesManagerMock = new Mock<IRulesManager>();
            testSubmission.Model.InterestedParties = new List<InterestedPartyModel>
            {
        ...
        /// </summary>
        [Fact]
        public async void IV_60_IpLastNameIsNull_InValid()
        {
            var rulesManagerMock = new Mock<IRulesManager>();
            testSubmission.Model.InterestedParties = new List<InterestedPartyModel>
            {
        ...
        /// </summary>
        [Fact]
        public async void IV_60_IpNameAndLastNameAreEmpty_InValid()
        {
            var rulesManagerMock = new Mock<IRulesManager>();
            testSubmission.Model.InterestedParties = new List<InterestedPartyModel>
            {
        ...
        /// </summary>
        [Fact]
        public async void IV_60_IpNameIsEmpty_InValid()
        {
            var rulesManagerMock = new Mock<IRulesManager>();
            testSubmission.Model.InterestedParties = new List<InterestedPartyModel>
            {
        ...
        /// </summary>
        [Fact]
        public async void IV_60_IpLastNameIsEmpty_InValid()
        {
            var rulesManagerMock = new Mock<IRulesManager>();
            testSubmission.Model.InterestedParties = new List<InterestedPartyModel>
            {
        ...
        /// </summary>
        [Fact]
        public async void IV_60_IpNameAndLastNameAreProvided_InValid()
        {
            var rulesManagerMock = new Mock<IRulesManager>();
            testSubmission.Model.InterestedParties = new List<InterestedPartyModel>
            {
