...
namespace SpanishPoint.Azure.Iswc.PipelineComponents.StaticDataValidator.Tests.Rules
{
    ...
    public class IV_38Tests : TestBase
    {
        ...
        /// </summary>
        [Fact]
        public async void IV_38_Submission_IswcPattern_InValid()
        {
        ...
        /// </summary>
        [Fact]
        public async void IV_38_Submission_NoDF_InValid()
        {
            var submission = new Submission() { Model = new SubmissionModel() };
            var workManager = new Mock<IWorkManager>();
			var rulesManagerMock = new Mock<IRulesManager>();
        ...
        /// </summary>
        [Fact]
        public async void IV_38_Submission_IswcNoInDb_InValid()
        {
            var submission = new Submission() { Model = new SubmissionModel() };
            var workManager = new Mock<IWorkManager>();
			var rulesManagerMock = new Mock<IRulesManager>();
        ...
        /// </summary>
        [Fact]
        public async void IV_38_Submission_Valid()
        {
            var submission = new Submission() { Model = new SubmissionModel() };
            var workManager = new Mock<IWorkManager>();
			var rulesManagerMock = new Mock<IRulesManager>();
        ...
        /// </summary>
        [Fact]
        public async void IV_38_Submission_HasTitleOnly_Valid()
        {
            var submission = new Submission() { Model = new SubmissionModel() };
            var workManager = new Mock<IWorkManager>();
			var rulesManagerMock = new Mock<IRulesManager>();
		...
		/// </summary>
		[Fact]
		public async void IV_38_Submission_HasIswcOnly_Valid()
		{
			var submission = new Submission() { Model = new SubmissionModel() };
			var workManager = new Mock<IWorkManager>();
			var rulesManagerMock = new Mock<IRulesManager>();
		...
		/// </summary>
		[Fact]
        public async void IV_38_Submission_Valid_Rule()
        {
            var submission = new Submission() { Model = new SubmissionModel() };
            var workManager = new Mock<IWorkManager>();
            var rulesManagerMock = new Mock<IRulesManager>();
        ...
        /// </summary>
        [Fact]
        public async void IV_38_Submission_NoW_InValid()
        {
            var submission = new Submission() { Model = new SubmissionModel() };
            var workManager = new Mock<IWorkManager>();
            var rulesManagerMock = new Mock<IRulesManager>();
