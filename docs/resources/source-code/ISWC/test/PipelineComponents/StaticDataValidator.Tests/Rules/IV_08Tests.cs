...
namespace SpanishPoint.Azure.Iswc.PipelineComponents.StaticDataValidator.Tests.Rules
{
    ...
    public class IV_08Tests : TestBase
    {
        ...
        /// </summary>
        [Fact]
        public async void IV_08_Submission_InValid()
        {
        ...
        /// </summary>
        [Fact]
        public async void IV_08_Submission_Valid()
        {
            var submission = new Submission()
            {
                Model = new SubmissionModel()
        ...
        /// </summary>
        [Fact]
        public async void IV_08_Submission_Valid_Rule()
        {
            var submission = new Submission()
            {
                Model = new SubmissionModel()
        ...
        /// </summary>
        [Fact]
        public async void IV_08_Submission_InValid_SourceDb_0()
        {
            var submission = new Submission()
            {
                Model = new SubmissionModel()
        ...
        /// </summary>
        [Fact]
        public async void IV_08_Submission_InValid_Agency()
        {
            var submission = new Submission()
            {
                Model = new SubmissionModel()
