...
{
    /// <summary>
    /// Checks for processing scenario AS_13
    /// </summary>
    public class AS_13Tests : ProcessingTestBase
    {
        /// <summary>
        /// Checks full AS_13 mapping from submission
        /// </summary>
        [Fact]
        public void AS_13_Valid()
        {
            ...
            var as13Mock = new Mock<AS_13>(workManager.Object, as_10Mock, mapperMock.Object).Object;

            Assert.Equal(PreferedIswcType.Existing, as13Mock.PreferedIswcType);
            Assert.False(as13Mock.IsEligible);
            Assert.Contains(TransactionType.FSQ, as13Mock.ValidTransactionTypes);
            Assert.Equal(nameof(AS_13), as13Mock.Identifier);
        }
        ...
        /// </summary>
        [Fact]
        public void AS_13_CheckMapping_WorkInfo()
        {
        ...
        /// </summary>
        [Fact]
        public void AS_13_CheckMapping_Title()
        {
            var myProfile = new MappingProfile();
            var configuration = new MapperConfiguration(cfg => cfg.AddProfile(myProfile));
            var mapper = new Mapper(configuration);
        ...
        /// </summary> 
        [Fact]
        public void AS_13_CheckMapping_Creator()
        {
            var myProfile = new MappingProfile();
            var configuration = new MapperConfiguration(cfg => cfg.AddProfile(myProfile));
            var mapper = new Mapper(configuration);
        ...
        /// </summary> 
        [Fact]
        public void AS_13_CheckMapping_Publishers()
        {
            var myProfile = new MappingProfile();
            var configuration = new MapperConfiguration(cfg => cfg.AddProfile(myProfile));
            var mapper = new Mapper(configuration);
        ...
        /// </summary> 
        [Fact]
        public void AS_13_CheckMapping_DerivedFrom()
        {
            var myProfile = new MappingProfile();
            var configuration = new MapperConfiguration(cfg => cfg.AddProfile(myProfile));
            var mapper = new Mapper(configuration);
        ...
        /// </summary> 
        [Fact]
        public void AS_13_CheckMapping_DisambiguationISWC()
        {
            var myProfile = new MappingProfile();
            var configuration = new MapperConfiguration(cfg => cfg.AddProfile(myProfile));
            var mapper = new Mapper(configuration);
