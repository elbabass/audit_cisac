...
namespace SpanishPoint.Azure.Iswc.PipelineComponents.PostMatchingValidator.Tests.Rules
{
    ...
    public class PV_09Tests : TestBase
	{
        ...
        /// </summary>
        [Fact]
		public async void PV_09_FindWithWorkCode_Valid()
		{
        ...
        /// </summary>
        [Fact]
		public async void PV_09_FindWithPreferredIswc_Valid()
		{
        ...
        /// </summary>
        [Fact]
		public async void PV_09_IswcIsDeleted_InValid()
		{
			var submission = new Submission() { Model = new SubmissionModel(), TransactionType = TransactionType.MER };
			var workManagerMock = new Mock<IWorkManager>();
        ...
        /// </summary>
        [Fact]
		public async void PV_09_WorkDoesNotExist_InValid()
		{
			var submission = new Submission() { Model = new SubmissionModel(), TransactionType = TransactionType.MER };
			var workManagerMock = new Mock<IWorkManager>();
        ...
        /// </summary>
        [Fact]
		public async void PV_09_IswcDoesNotExist_InValid()
		{
			var submission = new Submission() { Model = new SubmissionModel(), TransactionType = TransactionType.MER };
			var workManagerMock = new Mock<IWorkManager>();
		...
		/// </summary>
		[Fact]
		public async void PV_09_DMR_Valid()
		{
		...
		/// </summary>
		[Fact]
		public async void PV_09_DMR_InValid()
		{
			var submission = new Submission() { Model = new SubmissionModel() { PreferredIswc = "T2030000042" }, TransactionType = TransactionType.DMR };
			var workManagerMock = new Mock<IWorkManager>();
		...
		/// </summary>
		[Fact]
		public async void PV_09_IsReplaced_InValid()
		{
			var submission = new Submission() { Model = new SubmissionModel() { PreferredIswc = "T2030000042" }, TransactionType = TransactionType.MER };
			var workManagerMock = new Mock<IWorkManager>();
		...
		/// </summary>
		[Fact]
		public async void PV_09_FindWithWorkCode_InValid()
		{
			var submission = new Submission() { Model = new SubmissionModel(), TransactionType = TransactionType.MER };
			var workManagerMock = new Mock<IWorkManager>();
