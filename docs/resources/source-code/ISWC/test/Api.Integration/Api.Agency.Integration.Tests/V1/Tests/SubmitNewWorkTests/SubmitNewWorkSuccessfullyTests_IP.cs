...
namespace SpanishPoint.Azure.Iswc.Api.Agency.Integration.Tests.V1.Tests.SubmitNewWorkTests
{
    ...
    public class SubmitNewWorkSuccessfullyTests_IP : TestBase, IClassFixture<SubmitNewWorkSuccessfullyTests_IP_Fixture>
    {
        ...
        {
            Skip.IfNot(await IsValidationRuleEnabled("ResolveIPIBaseNumber"), "ResolveIPIBaseNumber is set to FALSE.");
        ...
        {
            Skip.IfNot(await IsValidationRuleEnabled("AllowNonAffiliatedSubmissions"), "AllowNonAffiliatedSubmissions is set to FALSE.");
