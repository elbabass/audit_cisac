...
namespace SpanishPoint.Azure.Iswc.Api.Agency.Integration.Tests.V1.Data
{
    ...
    public static class InterestedParties
    {
        ...
        {
            new InterestedParty() { BaseNumber = "I-001248136-4", Role = InterestedPartyRole.CA, NameNumber = 46893543, Name = "PARKS DAVID OCTAVIUS" },
            new InterestedParty() { BaseNumber = "I-001236670-8", Role = InterestedPartyRole.CA, NameNumber = 46910187, Name = "BOOTHE DOUGLAS" },
