...
namespace SpanishPoint.Azure.Iswc.Api.Publisher.Integration.Tests.V1
{
    ...
    public partial interface IISWC_SearchClient
    {
        ...
        System.Threading.Tasks.Task<IPContextSearchResponse> ContextSearchAsync(IPContextSearchModel body);
    
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <summary>Publisher context search to find ISWC metadata</summary>
        /// <returns>Iswc metadata found</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<IPContextSearchResponse> ContextSearchAsync(IPContextSearchModel body, System.Threading.CancellationToken cancellationToken);
    ...
    public partial class ISWC_SearchClient : IISWC_SearchClient
    {
        ...
        /// <returns>Iswc metadata found</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<IPContextSearchResponse> ContextSearchAsync(IPContextSearchModel body)
        {
        ...
        /// <returns>Iswc metadata found</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<IPContextSearchResponse> ContextSearchAsync(IPContextSearchModel body, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == "200") 
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<IPContextSearchResponse>(response_, headers_).ConfigureAwait(false);
                        ...
                        return default(IPContextSearchResponse);
                    }
                    finally
                    {
                        if (response_ != null)
