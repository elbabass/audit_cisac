...
namespace SpanishPoint.Azure.Iswc.Api.Tests.Controllers
{
    ...
    public class MergeControllerTests
    {
        ...
        /// </summary>
        [Fact]
        public async void MergeSubmission_NoContent()
        {
        ...
        /// </summary>
        [Fact]
        public async void MergeSubmission_NotFound()
        {
            var pipelineManagerMock = new Mock<IPipelineManager>();
            var mapperMock = new Mock<IMapper>().Object;
            var contextAcessorMock = new Mock<IHttpContextAccessor>();
        ...
        /// </summary>
        [Fact]
        public async void MergeSubmission_BadRequest()
        {
            var pipelineManagerMock = new Mock<IPipelineManager>();
            var mapperMock = new Mock<IMapper>().Object;
            var contextAcessorMock = new Mock<IHttpContextAccessor>();
        ...
        /// </summary>
        [Fact]
        public async void DemergeSubmission_NoContent()
        {
            var pipelineManagerMock = new Mock<IPipelineManager>();
            var mapperMock = new Mock<IMapper>().Object;
            var contextAcessorMock = new Mock<IHttpContextAccessor>();
        ...
        /// </summary>
        [Fact]
        public async void DemergeSubmission_NotFound()
        {
            var pipelineManagerMock = new Mock<IPipelineManager>();
            var mapperMock = new Mock<IMapper>().Object;
            var contextAcessorMock = new Mock<IHttpContextAccessor>();
        ...
        /// </summary>
        [Fact]
        public async void DemergeSubmission_BadRequest()
        {
            var pipelineManagerMock = new Mock<IPipelineManager>();
            var mapperMock = new Mock<IMapper>().Object;
            var contextAcessorMock = new Mock<IHttpContextAccessor>();
