...
namespace SpanishPoint.Azure.Iswc.Business.Tests.Managers
{
    ...
    public class MatchingManagerTests
    {
        ...
        /// </summary>
        [Fact]
        public async void Ranking_CalculatesRankScore()
        {
        ...
        /// </summary>
        [Fact]
        public async void Ranking_With_No_Title_CalculatesRankScore()
        {
            var matchingService = new Mock<IMatchingService>().Object;
            var workManagerMock = new Mock<IWorkManager>().Object;
            var iswcManagerMock = new Mock<IIswcRepository>().Object;
        ...
        /// </summary>
        [Fact]
        public async void Ranking_CalculatesRankScore_MultipleMatches()
        {
            var matchingService = new Mock<IMatchingService>().Object;
            var workManagerMock = new Mock<IWorkManager>().Object;
            var iswcManagerMock = new Mock<IIswcRepository>().Object;
        ...
        /// </summary>
        [Fact]
        public async void Ranking_CalculatesRankScore_MultipleMatches_WithErrors()
        {
            var matchingService = new Mock<IMatchingService>().Object;
            var workManagerMock = new Mock<IWorkManager>().Object;
            var iswcManagerMock = new Mock<IIswcRepository>().Object;
        ...
        /// </summary>
        [Fact]
        public async void Returns_MatchResults()
        {
        ...
        /// </summary>
        [Fact]
        public async void Ranking_AddToRankScore()
        {
            var matchingService = new Mock<IMatchingService>().Object;
            var workManagerMock = new Mock<IWorkManager>().Object;
            var iswcManagerMock = new Mock<IIswcRepository>().Object;
        ...
        /// </summary>
        [Fact]
        public async void Matching_Assigns_Archived_ISWC_To_Iswc_Property()
        {
            var matchingService = new Mock<IMatchingService>();
            var workManagerMock = new Mock<IWorkManager>();
            var iswcManagerMock = new Mock<IIswcRepository>();
        ...
        /// </summary>
        [Fact]
        public async void Matching_Does_Not_Assign_Archived_ISWC_To_Iswc_Property()
        {
            var matchingService = new Mock<IMatchingService>();
            var workManagerMock = new Mock<IWorkManager>();
            var iswcManagerMock = new Mock<IIswcRepository>();
        ...
        /// </summary>
        [Fact]
        public async void Eligible_Update_Submission_is_Assigned_Preferred_Iswc()
        {
            var matchingService = new Mock<IMatchingService>().Object;
            var workManagerMock = new Mock<IWorkManager>().Object;
            var iswcManagerMock = new Mock<IIswcRepository>().Object;
        ...
        /// </summary>
        [Fact]
        public async void InEligible_Update_Submission_is_Assigned_Preferred_Iswc()
        {
            var matchingService = new Mock<IMatchingService>().Object;
            var workManagerMock = new Mock<IWorkManager>().Object;
            var iswcManagerMock = new Mock<IIswcRepository>().Object;
        ...
        public async void Submission_With_Matching_Isrc_Assigned_Preferred_Iswc_And_Not_Flagged()
        {
            // Arrange
        ...
        /// </summary>
        [Fact(Skip = "Requires updating after ISRC cross-checking changes")]
        public async void Submission_With_Multiple_Isrc_Iswc_Preferred_Matches_Is_Flagged()
        {
            // Arrange
            var testMappedWorkInfo = new SubmissionModel()
            {
        ...
        /// </summary>
        [Fact(Skip = "Requires updating after ISRC cross-checking changes")]
        public async void Submission_Isrc_Iswc_Does_Not_Match_Metadata_Match_Is_Flagged()
        {
            // Arrange
            var testMappedWorkInfo = new SubmissionModel()
            {
