...
namespace SpanishPoint.Azure.Iswc.Business.Tests.Managers
{
    ...
    public class RulesManagerTests
    {
        ...
        /// </summary>
        [Fact]
        public async void Deserialize_Returns_String()
        {
        ...
        /// </summary>
        [Fact]
        public async void Deserialize_Returns_Int()
        {
            var parameter = "param1";
            var value = "1";
        ...
        /// </summary>
        [Fact]
        public async void Deserialize_Returns_Bool()
        {
        ...
        /// </summary>
        [Fact]
        public async void DeserializeEnumerable_Returns_ListOfStrings()
        {
            var parameter = "param1";
            var value = "str1,str2";
        ...
        /// </summary>
        [Fact]
        public async void DeserializeEnumerable_Returns_ListOfEnums()
        {
            var parameter = "param1";
            var value = "CAR,CUR";
