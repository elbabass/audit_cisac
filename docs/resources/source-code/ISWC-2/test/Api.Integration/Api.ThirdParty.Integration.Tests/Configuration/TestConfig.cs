...
namespace SpanishPoint.Azure.Iswc.Api.ThirdParty.Integration.Tests.Configuration
{
    public class TestConfig
    {
        ...
        public string MatchingEngineMicrosoftEntraIDClientID { get; set; }
        public string MatchingEngineMicrosoftEntraIDClientSecret { get; set; }
        public string MatchingEngineMicrosoftEntraIDScope { get; set; }
