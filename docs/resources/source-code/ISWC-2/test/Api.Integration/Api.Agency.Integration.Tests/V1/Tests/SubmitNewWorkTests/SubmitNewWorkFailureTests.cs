...
namespace SpanishPoint.Azure.Iswc.Api.Agency.Integration.Tests.V1.Tests.SubmitNewWorkTests
{
    ...
    public class SubmitNewWorkFailureTests : TestBase, IClassFixture<SubmitNewWorkFailureTests_Fixture>
    {
        ...
        {
            Xunit.Skip.If(await IsValidationRuleEnabled("AllowPDWorkSubmissions"), "AllowPDWorkSubmissions is set to TRUE.");
        ...
        {
            Xunit.Skip.If(await IsValidationRuleEnabled("AllowNonAffiliatedSubmissions"), "AllowNonAffiliatedSubmissions is set to TRUE.");
        ...
        {
            Xunit.Skip.IfNot(await IsValidationRuleEnabled("ValidateSubmittingAgency"), "ValidateSubmittingAgency is set to FALSE.");
        ...
        public async void SubmitNewWorkFailureTests_15()
        {
            ...
            Xunit.Skip.If(paramValue != "true", "ValidateExcerpt not set to true");
            var submission = Submissions.EligibleSubmissionAEPI;
        ...
        public async void SubmitNewWorkFailureTests_16()
        {
            ...
            Xunit.Skip.If(paramValue != "true", "ValidateComposite not set to true");
            var submission = Submissions.EligibleSubmissionAEPI;
            submission.DerivedFromIswcs = new List<DerivedFrom>()
            {
                new DerivedFrom() { Iswc = "", Title = "", }
