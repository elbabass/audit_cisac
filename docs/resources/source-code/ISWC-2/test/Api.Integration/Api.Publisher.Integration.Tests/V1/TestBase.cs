...
using SpanishPoint.Azure.Iswc.Api.Publisher.Integration.Tests.Configuration;
using SpanishPoint.Azure.Iswc.Api.Publisher.Integration.Tests.Extensions;
using System;
...
namespace SpanishPoint.Azure.Iswc.Api.Publisher.Integration.Tests.V1
{
