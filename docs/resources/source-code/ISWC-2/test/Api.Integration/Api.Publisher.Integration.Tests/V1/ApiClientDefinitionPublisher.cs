...
namespace SpanishPoint.Azure.Iswc.Api.Publisher.Integration.Tests.V1
{
    ...
    public partial interface IISWC_SearchClient
    {
        ...
        System.Threading.Tasks.Task<System.Collections.Generic.ICollection<IPContextSearchResponse>> ContextSearchAsync(IPContextSearchModel body);
    
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <summary>Publisher context search to find ISWC metadata</summary>
        /// <returns>Iswc metadata found</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<System.Collections.Generic.ICollection<IPContextSearchResponse>> ContextSearchAsync(IPContextSearchModel body, System.Threading.CancellationToken cancellationToken);
        ...
        /// <returns>Iswc metadata found</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<System.Collections.Generic.ICollection<IPContextSearchResponseBatch>> ContextSearchBatchAsync(System.Collections.Generic.IEnumerable<IPContextSearchModel> body);
        ...
        /// <returns>Iswc metadata found</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<System.Collections.Generic.ICollection<IPContextSearchResponseBatch>> ContextSearchBatchAsync(System.Collections.Generic.IEnumerable<IPContextSearchModel> body, System.Threading.CancellationToken cancellationToken);
    ...
    public partial class ISWC_SearchClient : IISWC_SearchClient
    {
        ...
        /// <returns>Iswc metadata found</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<System.Collections.Generic.ICollection<IPContextSearchResponse>> ContextSearchAsync(IPContextSearchModel body)
        {
            return ContextSearchAsync(body, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Iswc metadata found</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<IPContextSearchResponse>> ContextSearchAsync(IPContextSearchModel body, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == "200") 
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<System.Collections.Generic.ICollection<IPContextSearchResponse>>(response_, headers_).ConfigureAwait(false);
                        ...
                        if (status_ == "400") 
                        {
                            ...
                            throw new ApiException("Invalid IP Context Search Model supplied", (int)response_.StatusCode, responseText_, headers_, null);
                        }
                        else
                        if (status_ == "404") 
                        {
                            string responseText_ = ( response_.Content == null ) ? string.Empty : await response_.Content.ReadAsStringAsync().ConfigureAwait(false);
                            throw new ApiException("IP not found", (int)response_.StatusCode, responseText_, headers_, null);
                        }
                        else
                        ...
                        return default(System.Collections.Generic.ICollection<IPContextSearchResponse>);
                    }
                    finally
                    {
                        if (response_ != null)
        ...
        /// <returns>Iswc metadata found</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<System.Collections.Generic.ICollection<IPContextSearchResponseBatch>> ContextSearchBatchAsync(System.Collections.Generic.IEnumerable<IPContextSearchModel> body)
        {
            return ContextSearchBatchAsync(body, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Iswc metadata found</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<IPContextSearchResponseBatch>> ContextSearchBatchAsync(System.Collections.Generic.IEnumerable<IPContextSearchModel> body, System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append("context/search/batch");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == "207") 
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<System.Collections.Generic.ICollection<IPContextSearchResponseBatch>>(response_, headers_).ConfigureAwait(false);
                            return objectResponse_.Object;
                        }
                        else
                        if (status_ == "400") 
                        ...
                        return default(System.Collections.Generic.ICollection<IPContextSearchResponseBatch>);
                    }
                    finally
                    {
                        if (response_ != null)
    ...
    public partial class MatchingWork 
    {
        ...
        public System.Collections.Generic.ICollection<WorkNumber> WorkNumbers { get; set; }
        ...
        public System.Collections.Generic.ICollection<InterestedParty> OtherInterestedParties { get; set; }
    ...
    public partial class IPContextSearchModel 
    {
        ...
        public System.Collections.Generic.ICollection<Affiliations> Affiliations { get; set; }
        ...
        [Newtonsoft.Json.JsonProperty("works", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<Works> Works { get; set; }
    ...
    public partial class IPContextSearchResponse 
    {
        ...
        public System.Collections.Generic.ICollection<MatchingWork> MatchingIswcs { get; set; }
    ...
    public partial class IPContextSearchResponseBatch 
    {
        ...
        [Newtonsoft.Json.JsonProperty("searchResults", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<IPContextSearchResponse> SearchResults { get; set; }
    ...
    public partial class Works 
    {
        ...
        public System.Collections.Generic.ICollection<WorkNumber> WorkCodes { get; set; }
