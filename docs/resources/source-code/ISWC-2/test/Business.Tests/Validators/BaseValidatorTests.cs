...
namespace SpanishPoint.Azure.Iswc.Business.Tests.Validators
{
    ...
    public class BaseValidatorTests
    {
        ...
        /// </summary>
        [Fact]
        public async Task ValidateBatch_ReturnsAllSubmissions()
        {
        ...
        /// </summary>
        [Fact]
        public async Task ValidateBatch_Returns_ValidSubmissions()
        {
        ...
        /// </summary>
        [Fact]
        public async Task ValidateBatch_Returns_InvalidSubmissions()
        {
            var submission = new Submission() { TransactionType = TransactionType.CAR };
            var rule = new Mock<IRule>(); var batch = new List<Submission>() { submission };
        ...
        /// </summary>
        [Fact]
        public async Task ValidateBatch_SubmissionWithDifferentTransactionType()
        {
            var submission = new Submission() { TransactionType = TransactionType.CAR };
            var rule = new Mock<IRule>(); var batch = new List<Submission>() { submission };
        ...
        /// </summary>
        [Fact]
        public async Task ValidateBatch_SubmissionWithSameValidatorType()
        {
        ...
        /// </summary>
        [Fact]
        public async Task ValidateBatch_SubmissionWithDifferentValidatorType()
        {
            var submission = new Submission() { TransactionType = TransactionType.CUR };
            var rule = new Mock<IRule>(); var batch = new List<Submission>() { submission };
        ...
        /// </summary>
        [Fact]
        public async Task ValidateBatch_IfRejectionIsPresentDontValidate()
        {
