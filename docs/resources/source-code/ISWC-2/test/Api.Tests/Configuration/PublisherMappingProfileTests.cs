...
{
    /// <summary>
    /// Unit tests for SpanishPoint.Azure.Iswc.Api.Label.Configuration.PublisherMappingProfile
    /// </summary>
    public class PublisherMappingProfileTests
    {
        /// <summary>
        /// Tests that Publisher.V1.InterestedParty maps correctly to an InterestedPartyModel.
        /// </summary>
        [Fact]
        ...
        /// <summary>
        /// Tests that WorkNumber maps correctly to Publisher.V1.WorkNumber.
        /// </summary>
        [Fact]
        ...
        /// <summary>
        /// Tests that Publisher.V1.IPContextSearchModel maps correctly to a SubmissionModel.
        /// </summary>
        [Fact]
        ...
        /// <summary>
        /// Tests that Publisher.V1.WorkNumber maps correctly to AdditionalAgencyWorkNumber.
        /// </summary>
        [Fact]
        ...
        /// <summary>
        /// Tests that Publisher.V1.Works maps correctly to a WorkModel.
        /// </summary>
        [Fact]
        ...
        /// <summary>
        /// Tests that Submission maps to IPContextSearchResponseBatch with MatchingIswcs from SearchedIswcModels.
        /// </summary>
        [Fact]
        public void Map_Submission_To_IPContextSearchResponseBatch_With_MatchingIswcs_From_SearchedIswcModels()
        {
            ...
            var response = result.SearchResults.First();
            Assert.Equal("ANDREW JOHN", response.FirstName);
            Assert.Equal("HOZIER BYRNE", response.LastName);
            Assert.Equal(589238793, response.NameNumber);

            var matchingIswcs = response.MatchingIswcs;
