...
namespace SpanishPoint.Azure.Iswc.Api.Tests.Controllers
{
    ...
    public class SearchControllerTests
    {
        ...
        /// </summary>
        [Fact]
        public async Task SearchByAgencyWorkCodeOk()
        {
        ...
        /// </summary>
        [Fact]
        public async Task SearchByAgencyWorkCodeNotFound()
        {
            var pipelineManagerMock = new Mock<IPipelineManager>();
            var mapperMock = new Mock<IMapper>();
            var contextAcessorMock = new Mock<IHttpContextAccessor>();
        ...
        /// </summary>
        [Fact]
        public async Task SearchByAgencyWorkCodeBadRequestd()
        {
            var pipelineManagerMock = new Mock<IPipelineManager>();
            var mapperMock = new Mock<IMapper>();
            var contextAcessorMock = new Mock<IHttpContextAccessor>();
        ...
        /// </summary>
        [Fact]
        public async Task SearchByIswcOk()
        {
            var pipelineManagerMock = new Mock<IPipelineManager>();
            var mapperMock = new Mock<IMapper>();
            var contextAcessorMock = new Mock<IHttpContextAccessor>();
        ...
        /// </summary>
        [Fact]
        public async Task SearchByIswcNotFound()
        {
            var pipelineManagerMock = new Mock<IPipelineManager>();
            var mapperMock = new Mock<IMapper>();
            var contextAcessorMock = new Mock<IHttpContextAccessor>();
        ...
        /// </summary>
        [Fact]
        public async Task SearchByIswcBadRequestd()
        {
            var pipelineManagerMock = new Mock<IPipelineManager>();
            var mapperMock = new Mock<IMapper>();
            var contextAcessorMock = new Mock<IHttpContextAccessor>();
        ...
        /// </summary>
        [Fact]
        public async Task SearchByTitleAndContributorOk()
        {
            var pipelineManagerMock = new Mock<IPipelineManager>();
            var mapperMock = new Mock<IMapper>();
            var contextAcessorMock = new Mock<IHttpContextAccessor>();
        ...
        /// </summary>
        [Fact]
        public async Task SearchByTitleAndContributorNotFound()
        {
            var pipelineManagerMock = new Mock<IPipelineManager>();
            var mapperMock = new Mock<IMapper>();
            var contextAcessorMock = new Mock<IHttpContextAccessor>();
        ...
        /// </summary>
        [Fact]
        public async Task SearchByTitleAndContributorBadRequestd()
        {
            var pipelineManagerMock = new Mock<IPipelineManager>();
            var mapperMock = new Mock<IMapper>();
            var contextAcessorMock = new Mock<IHttpContextAccessor>();
