...
namespace SpanishPoint.Azure.Iswc.Api.Tests.Controllers
{
    ...
    public class SubmissionControllerTests
    {
        ...
        /// </summary>
        [Fact]
        public async Task AddSubmission_Ok()
        {
        ...
        /// </summary>
        [Fact]
        public async Task AddSubmission_BadRequest()
        {
            var pipelineManagerMock = new Mock<IPipelineManager>();
            var mapperMock = new Mock<IMapper>().Object;
            var contextAcessorMock = new Mock<IHttpContextAccessor>();
        ...
        /// </summary>
        [Fact]
        public async Task AddSubmissionBatch()
        {
            var pipelineManagerMock = new Mock<IPipelineManager>();
            var mapperMock = new Mock<IMapper>().Object;
            var contextAcessorMock = new Mock<IHttpContextAccessor>();
        ...
        /// </summary>
        [Fact]
        public async Task UpdateSubmission_Ok()
        {
            var pipelineManagerMock = new Mock<IPipelineManager>();
            var mapperMock = new Mock<IMapper>().Object;
            var contextAcessorMock = new Mock<IHttpContextAccessor>();
        ...
        /// </summary>
        [Fact]
        public async Task UpdateSubmission_No_Preferred_ISWC_Ok()
        {
            var pipelineManagerMock = new Mock<IPipelineManager>();
            var mapperMock = new Mock<IMapper>().Object;
            var contextAcessorMock = new Mock<IHttpContextAccessor>();
        ...
        /// </summary>
        [Fact]
        public async Task UpdateSubmission_BadRequest()
        {
            var pipelineManagerMock = new Mock<IPipelineManager>();
            var mapperMock = new Mock<IMapper>().Object;
            var contextAcessorMock = new Mock<IHttpContextAccessor>();
        ...
        /// </summary>
        [Fact]
        public async Task UpdateSubmissionBatch()
        {
            var pipelineManagerMock = new Mock<IPipelineManager>();
            var mapperMock = new Mock<IMapper>().Object;
            var contextAcessorMock = new Mock<IHttpContextAccessor>();
        ...
        /// </summary>
        [Fact]
        public async Task DeleteSubmission_NoContent()
        {
            var pipelineManagerMock = new Mock<IPipelineManager>();
            var mapperMock = new Mock<IMapper>().Object;
            var contextAcessorMock = new Mock<IHttpContextAccessor>();
        ...
        /// </summary>
        [Fact]
        public async Task DeleteSubmission_BadRequest()
        {
            var pipelineManagerMock = new Mock<IPipelineManager>();
            var mapperMock = new Mock<IMapper>().Object;
            var contextAcessorMock = new Mock<IHttpContextAccessor>();
