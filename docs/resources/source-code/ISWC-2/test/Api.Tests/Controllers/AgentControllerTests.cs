...
namespace SpanishPoint.Azure.Iswc.Api.Tests.Controllers
{
    ...
    public class AgentControllerTests
    {
        ...
        /// </summary>
        [Fact]
        public async Task UpdateAgentRun_Ok()
        {
        ...
        /// </summary>
        [Fact]
        public async Task UpdateAgentRun_NotFound()
        {
            var agentManagerMock = new Mock<IAgentManager>();
            var mapperMock = new Mock<IMapper>();
        ...
        /// </summary>
        [Fact]
        public async Task UpdateNotifications_Ok()
        {
            var agentManagerMock = new Mock<IAgentManager>();
            var mapperMock = new Mock<IMapper>();
        ...
        /// </summary>
        [Fact]
        public async Task UpdateNotifications_BadRequest()
        {
            var agentManagerMock = new Mock<IAgentManager>();
            var mapperMock = new Mock<IMapper>();
