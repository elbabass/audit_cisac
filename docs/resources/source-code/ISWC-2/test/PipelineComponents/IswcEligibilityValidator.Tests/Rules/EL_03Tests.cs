...
namespace SpanishPoint.Azure.Iswc.PipelineComponents.IswcEligibilityValidator.Tests.Rules
{
    ...
    public class EL_03Tests
    {
        ...
        /// </summary>
        [Fact]
        public async Task EL_03_EligibleOneIpRepresentedBySubmitter()
        {
        ...
        /// </summary>
        [Fact]
        public async Task EL_03_EligibleOneIPRepresentedBySubmitterRoleTypeIneligible()
        {
            var submission = new Submission() { Model = new SubmissionModel() };
        ...
        /// </summary>
        [Fact]
        public async Task EL_03_Ineligible()
        {
            var submission = new Submission() { Model = new SubmissionModel() };
        ...
        /// </summary>
        [Fact]
        public async Task EL_03_EligibleAllIPBaseNumbersPDAndEligibleRoles()
        {
            var submission = new Submission() { Model = new SubmissionModel() };
        ...
        /// </summary>
        [Fact]
        public async Task EL_03_InEligibleNotAllIPBaseNumbersPDAndEligibleRoles()
        {
            var submission = new Submission() { Model = new SubmissionModel() };
        ...
        /// </summary>
        [Fact]
        public async Task EL_03_InEligibleNotAllIPBaseNumbersPD()
        {
            var submission = new Submission() { Model = new SubmissionModel() };
        ...
        /// </summary>
        [Fact]
        public async Task EL_03_EligibleOneIpRepresentedBySubmitterChildAgency()
        {
            var submission = new Submission() { Model = new SubmissionModel() };
