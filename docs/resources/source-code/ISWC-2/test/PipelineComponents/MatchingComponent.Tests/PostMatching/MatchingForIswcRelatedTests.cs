...
namespace SpanishPoint.Azure.Iswc.PipelineComponents.MatchingComponent.Tests.PostMatching
{
    ...
    public class MatchingForIswcRelatedTests : TestBase
    {
        ...
        /// </summary>
        [Fact]
        public async Task DerivedFromIswc_NoMatches_Returns_Rejection()
        {
        ...
        /// </summary>
        [Fact]
        public async Task DerivedFromIswc_MultipleMatches_Returns_Rejection()
        {
        ...
        /// </summary>
        [Fact]
        public async Task MergeIswc_NoMatches_Returns_Rejection()
        {
            var matchingManagerMock = new Mock<IMatchingManager>();
            var messagingManagerMock = new Mock<IMessagingManager>();
        ...
        /// </summary>
        [Fact]
        public async Task MergeIswc_MultipleMatches_Returns_Rejection()
        {
        ...
        /// </summary>
        [Fact]
        public async Task WorkNumber_NoMatches_Returns_Rejection()
        {
            var matchingManagerMock = new Mock<IMatchingManager>();
            var messagingManagerMock = new Mock<IMessagingManager>();
        ...
        /// </summary>
        [Fact]
        public async Task WorkNumber_MultipleMatches_Returns_Rejection()
        {
            var matchingManagerMock = new Mock<IMatchingManager>();
            var messagingManagerMock = new Mock<IMessagingManager>();
