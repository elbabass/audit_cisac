...
{
    /// <summary>
    /// Tests for the MatchingForIswcNonEligibleSubmitter class
    /// </summary>
    public class MatchingForIswcNonEligibleSubmitterTests
    {
        /// <summary>
        ...
        public async Task ProcessSubmissions()
        {
            ...
            var component = new MatchingForIswcNonEligibleSubmitter(manager.Object);
