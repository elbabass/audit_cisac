...
{
    /// <summary>
    /// Tests for the MatchingForIswcEligibleSubmitter component
    /// </summary>
    public class MatchingForIswcEligibleSubmitterTests
    {
        /// <summary>
        ...
        public async Task ProcessSubmissions()
        {
            ...
            var component = new MatchingForIswcEligibleSubmitter(manager.Object);
