...
{
    /// <summary>
    /// Tests for the MatchingForIswcNonEligibleExisting component
    /// </summary>
    public class MatchingForIswcNonEligibleExistingTests
    {
        /// <summary>
        ...
        public async Task ProcessSubmissions()
        {
            ...
            var component = new MatchingForIswcNonEligibleExisting(manager.Object);

            var submissions = new List<Submission>()
            {
                new Submission() { SubmissionId = 1, IsEligible = false }
            };
