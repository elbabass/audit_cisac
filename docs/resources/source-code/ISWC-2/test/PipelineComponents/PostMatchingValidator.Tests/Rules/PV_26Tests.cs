...
namespace SpanishPoint.Azure.Iswc.PipelineComponents.PostMatchingValidator.Tests.Rules
{
    ...
    public class PV_26Tests : TestBase
    {
        ...
        /// </summary>
        [Fact]
        public async Task PV_26_MissingRequiredFields_InValid()
        {
        ...
        /// </summary>
        [Fact]
        public async Task PV_26_WorkNotFoundByWorkNumber_InValid()
        {
            var submission = new Submission()
            {
                MatchedResult = new MatchResult()
        ...
        /// </summary>
        [Fact]
        public async Task PV_26_WorkMetaDataDoesNotMatch_InValid()
        {
            var submission = new Submission()
            {
                MatchedResult = new MatchResult()
        ...
        /// </summary>
        [Fact]
        public async Task PV_26_PreferredISWCDoesNotMatch_InValid()
        {
            var submission = new Submission()
            {
                MatchedResult = null,
        ...
        /// </summary>
        [Fact]
        public async Task PV_26_TitleStandardization_Valid()
        {
            var submission = new Submission()
            {
                IsEligible = false,
        ...
        /// </summary>
        [Fact]
        public async Task PV_26_TitleStandardization_InValid()
        {
            var submission = new Submission()
            {
                IsEligible = false,
