...
namespace SpanishPoint.Azure.Iswc.PipelineComponents.PostMatchingValidator.Tests.Rules
{
    ...
    public class PV_24Tests : TestBase
    {
        ...
        /// </summary>
        [Fact]
        public async Task PV_24_PreferredIswcDoesNotExist_InValid()
        {
        ...
        /// </summary>
        [Fact]
        public async Task PV_24_PreferredIswcDoesNotMatchArchived_InValid()
        {
            var submission = new Submission() { Model = new SubmissionModel(), TransactionType = TransactionType.CAR };
            var workManagerMock = new Mock<IWorkManager>();
        ...
        /// </summary>
        [Fact]
        public async Task PV_24_PreferredIswcDoesExist_Valid()
        {
            var submission = new Submission() { Model = new SubmissionModel(), TransactionType = TransactionType.CAR };
            var workManagerMock = new Mock<IWorkManager>();
        ...
        /// </summary>
        [Fact]
        public async Task PV_24_LocallyAssignedIswcDoesExist_Invalid()
        {
            var submission = new Submission() { Model = new SubmissionModel(), TransactionType = TransactionType.CAR };
            var workManagerMock = new Mock<IWorkManager>();
        ...
        /// </summary>
        [Fact]
        public async Task PV_24_LocallyAssignedIswcDoesNotExist_Valid()
        {
            var submission = new Submission() { Model = new SubmissionModel(), TransactionType = TransactionType.CAR };
            var workManagerMock = new Mock<IWorkManager>();
