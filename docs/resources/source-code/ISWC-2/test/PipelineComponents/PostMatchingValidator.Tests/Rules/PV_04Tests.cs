...
namespace SpanishPoint.Azure.Iswc.PipelineComponents.PostMatchingValidator.Tests.Rules
{
    ...
    public class PV_04Tests : TestBase
    {
        ...
        /// </summary>
        [Fact]
        public async Task PV_04_NoMatchesToCheck_Valid()
        {
        ...
        /// </summary>
        [Fact]
        public async Task PV_04_IPNumbersDoNotMatch_InValid()
        {
        ...
        /// </summary>
        [Fact]
        public async Task PV_04_TitlesDoNotMatch_InValid()
        {
            var matchedResult = new MatchResult();
            matchedResult.Matches = new List<MatchingWork>() {
                new MatchingWork() {
        ...
        /// </summary>
        [Fact]
        public async Task PV_04_TitleTypeDoesNotMatch_InValid()
        {
            var matchedResult = new MatchResult();
            matchedResult.Matches = new List<MatchingWork>() {
                new MatchingWork() {
        ...
        /// </summary>
        [Fact]
        public async Task PV_04_RunIfOnlyOneIswcInMatches()
        {
            var matchedResult = new MatchResult();
            matchedResult.Matches = new List<MatchingWork>() {
                new MatchingWork() {
        ...
        /// </summary>
        [Fact]
        public async Task PV_04_TitlesDoNotMatchPreviewDisambiguationTrue_Valid()
        {
            var matchedResult = new MatchResult();
            matchedResult.Matches = new List<MatchingWork>() {
                new MatchingWork() {
        ...
        /// </summary>
        [Fact]
        public async Task PV_04_PVTitleStandardization_Valid()
        {
            var matchedResult = new MatchResult();
        ...
        /// </summary>
        [Fact]
        public async Task PV_04_PVTitleStandardization_InValid()
        {
            var matchedResult = new MatchResult();
            matchedResult.StandardizedName = "title";
            matchedResult.Matches = new List<MatchingWork>() {
