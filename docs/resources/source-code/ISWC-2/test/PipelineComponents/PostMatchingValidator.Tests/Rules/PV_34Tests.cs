...
namespace SpanishPoint.Azure.Iswc.PipelineComponents.PostMatchingValidator.Tests.Rules
{
    ...
    public class PV_34Tests: TestBase
	{
        ...
        /// </summary>
        [Fact]
        public async Task PV_34_MetadataMatchNoIsrcMatch_Valid()
        {
        ...
        /// </summary>
        [Fact]
        public async Task PV_34_IsrcMatchNoMetadataMatch_Valid()
        {
            var submission = new Submission()
            {
        ...
        /// </summary>
        [Fact]
        public async Task PV_34_NoMetadataMatchNoIsrcMatch_Valid()
        {
            var submission = new Submission()
            {
                TransactionType = TransactionType.CAR
        ...
        /// </summary>
        [Fact]
        public async Task PV_34_PV_34_SameMetadataMatchAsIsrcMatch_Valid()
        {
            var submission = new Submission()
            {
                MatchedResult = new MatchResult()
        ...
        /// </summary>
        [Fact]
		public async Task PV_34_DifferentMetadataMatchToIsrcMatch_InValid()
		{
            var submission = new Submission()
            {
                MatchedResult = new MatchResult()
