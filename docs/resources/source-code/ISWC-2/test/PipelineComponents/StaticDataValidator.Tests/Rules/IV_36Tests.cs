...
namespace SpanishPoint.Azure.Iswc.PipelineComponents.StaticDataValidator.Tests.Rules
{
    ...
    public class IV_36Tests : TestBase
    {
        ...
        /// </summary>
        [Fact]
        public async Task IV_36_Submission_IswcPattern_InValid()
        {
        ...
        /// </summary>
        [Fact]
        public async Task IV_36_Submission_IswcNoInDb_InValid()
        {
            var submission = new Submission() { Model = new SubmissionModel() };
            var workManager = new Mock<IWorkManager>();
			var rulesManagerMock = new Mock<IRulesManager>();
        ...
        /// </summary>
        [Fact]
        public async Task IV_36_Submission_NoTitleOrIswc_InValid()
        {
            var submission = new Submission() { Model = new SubmissionModel() };
            var workManager = new Mock<IWorkManager>();
			var rulesManagerMock = new Mock<IRulesManager>();
        ...
        /// </summary>
        [Fact]
        public async Task IV_36_Submission_NoDF_InValid()
        {
            var submission = new Submission() { Model = new SubmissionModel() };
            var workManager = new Mock<IWorkManager>();
			var rulesManagerMock = new Mock<IRulesManager>();
        ...
        /// </summary>
        [Fact]
        public async Task IV_36_Submission_Valid()
        {
            var submission = new Submission() { Model = new SubmissionModel() };
            var workManager = new Mock<IWorkManager>();
			var rulesManagerMock = new Mock<IRulesManager>();
        ...
        /// </summary>
        [Fact]
        public async Task IV_36_Submission_HasTitleOnly_Valid()
        {
            var submission = new Submission() { Model = new SubmissionModel() };
            var workManager = new Mock<IWorkManager>();
			var rulesManagerMock = new Mock<IRulesManager>();
		...
		/// </summary>
		[Fact]
		public async Task IV_36_Submission_HasIswcOnly_Valid()
		{
			var submission = new Submission() { Model = new SubmissionModel() };
			var workManager = new Mock<IWorkManager>();
			var rulesManagerMock = new Mock<IRulesManager>();
        ...
        /// </summary>
        [Fact]
        public async Task IV_36_Submission_HasTitleOnly_Valid_Rule()
        {
            var submission = new Submission() { Model = new SubmissionModel() };
            var workManager = new Mock<IWorkManager>();
            var rulesManagerMock = new Mock<IRulesManager>();
