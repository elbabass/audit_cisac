...
namespace SpanishPoint.Azure.Iswc.PipelineComponents.StaticDataValidator.Tests.Rules
{
    ...
    public class IV_34Tests : TestBase
    {
        ...
        /// </summary>
        [Fact]
        public async Task IV_34_Submission_Basic_IswcPattern_InValid()
        {
        ...
        /// </summary>
        [Fact]
        public async Task IV_34_Submission_Basic_IswcNoInDb_InValid()
        {
            var submission = new Submission() { Model = new SubmissionModel() };
            var rulesManagerMock = new Mock<IRulesManager>();
            var workManager = new Mock<IWorkManager>();
        ...
        /// </summary>
        [Fact]
        public async Task IV_34_Submission_Basic_Valid()
        {
            var submission = new Submission() { Model = new SubmissionModel() };
            var rulesManagerMock = new Mock<IRulesManager>();
            var workManager = new Mock<IWorkManager>();
        ...
        /// </summary>
        [Fact]
        public async Task IV_34_Submission_Basic_Empty_ISWC_Valid()
        {
            var submission = new Submission() { Model = new SubmissionModel() };
            var rulesManagerMock = new Mock<IRulesManager>();
            var workManager = new Mock<IWorkManager>();
        ...
        /// </summary>
        [Fact]
        public async Task IV_34_Submission_Full_IswcPattern_InValid()
        {
            var submission = new Submission() { Model = new SubmissionModel() };
            var rulesManagerMock = new Mock<IRulesManager>();
            var workManager = new Mock<IWorkManager>();
        ...
        /// </summary>
        [Fact]
        public async Task IV_34_Submission_Full_IswcNoInDb_InValid()
        {
            var submission = new Submission() { Model = new SubmissionModel() };
            var rulesManagerMock = new Mock<IRulesManager>();
            var workManager = new Mock<IWorkManager>();
        ...
        /// </summary>
        [Fact]
        public async Task IV_34_Submission_Full_Valid()
        {
            var submission = new Submission() { Model = new SubmissionModel() };
            var rulesManagerMock = new Mock<IRulesManager>();
            var workManager = new Mock<IWorkManager>();
        ...
        /// </summary>
        [Fact]
        public async Task IV_34_Submission_Full_HasTitleOnly_Valid()
        {
            var submission = new Submission() { Model = new SubmissionModel() };
            var rulesManagerMock = new Mock<IRulesManager>();
            var workManager = new Mock<IWorkManager>();
		...
		/// </summary>
		[Fact]
		public async Task IV_34_Submission_Full_HasIswcOnly_Valid()
		{
			var submission = new Submission() { Model = new SubmissionModel() };
			var rulesManagerMock = new Mock<IRulesManager>();
			var workManager = new Mock<IWorkManager>();
        ...
        /// </summary>
        [Fact]
        public async Task IV_34_Submission_NoDF_InValid()
        {
            var submission = new Submission() { Model = new SubmissionModel() };
            var rulesManagerMock = new Mock<IRulesManager>();
            var workManager = new Mock<IWorkManager>();
        ...
        /// </summary>
        [Fact]
        public async Task IV_34_Submission_Full_NoTitleOrIswc_InValid()
        {
            var submission = new Submission() { Model = new SubmissionModel() };
            var rulesManagerMock = new Mock<IRulesManager>();
            var workManager = new Mock<IWorkManager>();
        ...
        /// </summary>
        [Fact]
        public async Task IV_34_Submission_None_Valid()
        {
            var submission = new Submission() { Model = new SubmissionModel() };
            var rulesManagerMock = new Mock<IRulesManager>();
            var workManager = new Mock<IWorkManager>();
