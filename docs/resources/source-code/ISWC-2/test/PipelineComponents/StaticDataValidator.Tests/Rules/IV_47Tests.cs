...
namespace SpanishPoint.Azure.Iswc.PipelineComponents.StaticDataValidator.Tests.Rules
{
    ...
    public class IV_47Tests : TestBase
    {
        ...
        /// </summary>
        [Fact]
        public async Task IV_11_Submission_Performer_LastName_InValid()
        {
        ...
        /// </summary>
        [Fact]
        public async Task IV_11_Submission_Performer_FirstName_InValid()
        {
            var rulesManagerMock = new Mock<IRulesManager>();
            var submission = new Submission()
            {
        ...
        /// </summary>
        [Fact]
        public async Task IV_11_Submission_Performer_No_Lastname_InValid()
        {
            var rulesManagerMock = new Mock<IRulesManager>();
            var submission = new Submission()
            {
        ...
        /// </summary>
        [Fact]
        public async Task IV_11_Submission_Valid()
        {
            var rulesManagerMock = new Mock<IRulesManager>();
            var submission = new Submission()
            {
