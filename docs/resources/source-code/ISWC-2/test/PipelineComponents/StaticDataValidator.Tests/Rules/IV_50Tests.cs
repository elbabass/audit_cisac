...
namespace SpanishPoint.Azure.Iswc.PipelineComponents.StaticDataValidator.Tests.Rules
{
    ...
    public class IV_50Tests : TestBase
    {
        ...
        /// </summary>
        [Fact]
        public async Task IV_50_E_IPs_Removed()
        {
        ...
        /// </summary>
        [Fact]
        public async Task IV_50_AM_IPs_Removed()
        {
            var submission = new Submission() { Model = new SubmissionModel() };
        ...
        /// </summary>
        [Fact]
        public async Task IV_50_Non_AM_E_IPs_Not_Removed()
        {
            var submission = new Submission() { Model = new SubmissionModel() };
        ...
        /// </summary>
        [Fact]
        public async Task IV_50_Non_AM_E_IPs_With_IpNameNumbers_Not_Removed()
        {
            var submission = new Submission() { Model = new SubmissionModel() };
