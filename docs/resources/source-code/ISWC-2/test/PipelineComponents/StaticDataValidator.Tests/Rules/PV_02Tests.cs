...
namespace SpanishPoint.Azure.Iswc.PipelineComponents.StaticDataValidator.Tests.Rules
{
    ...
    public class PV_02Tests : TestBase
    {
        ...
        /// </summary>
        [Fact]
        public async Task PV_02_NoMatchesToCheck_Valid()
        {
        ...
        /// </summary>
        [Fact]
        public async Task PV_02_WorkNumberAlreadyExistsInDb_Valid()
        {
        ...
        /// </summary>
        [Fact]
        public async Task PV_02_WorkNumberDoesNotExistInDb_Valid()
        {
            var testWorkNumber = new WorkNumber() { Number = "1" };
            var submission = new Submission()
            {
        ...
        /// </summary>
        [Fact]
        public async Task PV_02_DisableAddUpdateSwitching_Invalid()
        {
            var testWorkNumber = new WorkNumber() { Number = "1" };
            var submission = new Submission()
            {
        ...
        /// </summary>
        [Fact]
        public async Task PV_02_DisableAddUpdateSwitching_Valid()
        {
        ...
        /// </summary>
        [Fact]
        public async Task PV_02_LabelIdentifierWorkCodeAlreadyExistsInDb_Valid()
        {
            // arrange
            var submission = new Submission()
            {
        ...
        /// </summary>
        [Fact]
        public async Task PV_02_LabelIdentifierWorkCodeDoesNotExistInDb_Valid()
        {
            // arrange
            var submission = new Submission()
            {
        ...
        /// </summary>
        [Fact]
        public async Task PV_02_LabelIdentifierWorkCodeDisableUpdateSwitching_Invalid()
        {
            // arrange
            var submission = new Submission()
            {
        ...
        /// </summary>
        [Fact]
        public async Task PV_02_MultipleLabelIdentifiers_Invalid()
        {
            // arrange
            var submission = new Submission()
            {
