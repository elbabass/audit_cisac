...
namespace SpanishPoint.Azure.Iswc.PipelineComponents.StaticDataValidator.Tests.Rules
{
    ...
    public class IV_56Tests
    {
        ...
        /// </summary>
        [Fact]
        public async Task IV_56_TabChar()
        {
        ...
        /// </summary>
        [Fact]
        public async Task IV_56_LineFeedChar()
        {
            var rulesManagerMock = new Mock<IRulesManager>();
            var submission = new Submission() { Model = new SubmissionModel() };
            var test = new Mock<IV_56>(rulesManagerMock.Object);
        ...
        /// </summary>
        [Fact]
        public async Task IV_56_CarraigeReturnChar()
        {
            var rulesManagerMock = new Mock<IRulesManager>();
            var submission = new Submission() { Model = new SubmissionModel() };
            var test = new Mock<IV_56>(rulesManagerMock.Object);
        ...
        /// </summary>
        [Fact]
        public async Task IV_56_AddedString()
        {
            var rulesManagerMock = new Mock<IRulesManager>();
            var submission = new Submission() { Model = new SubmissionModel() };
            var test = new Mock<IV_56>(rulesManagerMock.Object);
        ...
        public async Task IV_56_RemoveSpecialCharsFromAgencyWorkcode(string testValue)
        {
            var rulesManagerMock = new Mock<IRulesManager>();
        ...
        [InlineData("TestWork\n")]
        [InlineData("TestWorkxyz")]
        public async Task IV_56_RemoveSpecialCharsFromAAdditionalAgencyWorkcodes(string testValue)
        {
            var rulesManagerMock = new Mock<IRulesManager>();
            var submission = new Submission
            {
