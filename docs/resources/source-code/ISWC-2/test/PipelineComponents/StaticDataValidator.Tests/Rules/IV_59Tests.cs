...
namespace SpanishPoint.Azure.Iswc.PipelineComponents.StaticDataValidator.Tests.Rules
{
    ...
    public class IV_59Tests : TestBase
    {
        ...
        /// </summary>
        [Fact]
        public async Task IV_59_SubmitterDpIdIsNull_InValid()
        {
        ...
        /// </summary>
        [Fact]
        public async Task IV_59_SubmitterDpIdIsEmpty_InValid()
        {
            var rulesManagerMock = new Mock<IRulesManager>();
            testSubmission.Model.AdditionalIdentifiers = new List<AdditionalIdentifier>
            {
        ...
        /// </summary>
        [Fact]
        public async Task IV_59_AddtionalIdentifiersNotProvided_InValid()
        {
            var rulesManagerMock = new Mock<IRulesManager>();
        ...
        /// </summary>
        [Fact]
        public async Task IV_59_SubmitterDpIdProvided_Valid()
        {
            var rulesManagerMock = new Mock<IRulesManager>();
            testSubmission.Model.AdditionalIdentifiers = new List<AdditionalIdentifier>
            {
