...
namespace SpanishPoint.Azure.Iswc.PipelineComponents.StaticDataValidator.Tests.Rules
{
    ...
    public class IV_40Tests : TestBase
    {
        ...
        /// </summary>
        [Fact]
        public async Task IV_40_Submission_NoDisambiguateFromIswcsProvided_InValid()
        {
        ...
        /// </summary>
        [Fact]
        public async Task IV_40_Submission_InValidIswcProvided_InValid()
        {
            var rulesManagerMock = new Mock<IRulesManager>();
            var instrumentationManagerMock = new Mock<ILookupManager>().Object;
            var submission = new Submission() { Model = new SubmissionModel() };
        ...
        /// </summary>
        [Fact]
        public async Task IV_40_Submission_NoPerformerLastname_InValid()
        {
            var rulesManagerMock = new Mock<IRulesManager>();
            var instrumentationManagerMock = new Mock<ILookupManager>().Object;
            var submission = new Submission() { Model = new SubmissionModel() };
        ...
        /// </summary>
        [Fact]
        public async Task IV_40_Submission_PerformersWithLastname_Valid()
        {
            var rulesManagerMock = new Mock<IRulesManager>();
            var instrumentationManagerMock = new Mock<ILookupManager>().Object;
            var submission = new Submission() { Model = new SubmissionModel() };
        ...
        /// </summary>
        [Fact]
        public async Task IV_40_Submission_DisambiguateFromIswcsProvided_Valid()
        {
            var rulesManagerMock = new Mock<IRulesManager>();
            var instrumentationManagerMock = new Mock<ILookupManager>().Object;
        ...
        /// </summary>
        [Fact]
        public async Task IV_40_Submission_NoDisambiguationReasonCodeProvided_InValid()
        {
            var rulesManagerMock = new Mock<IRulesManager>();
            var instrumentationManagerMock = new Mock<ILookupManager>().Object;
            var submission = new Submission() { };
        ...
        /// </summary>
        [Fact]
        public async Task IV_40_Submission_DisambiguationReasonCodeProvided_InValid()
        {
            var rulesManagerMock = new Mock<IRulesManager>();
            var instrumentationManagerMock = new Mock<ILookupManager>().Object;
            var submission = new Submission() { };
        ...
        /// </summary>
        [Fact]
        public async Task IV_40_Submission_BLTVR_InValid()
        {
            var rulesManagerMock = new Mock<IRulesManager>();
            var instrumentationManagerMock = new Mock<ILookupManager>().Object;
            var submission = new Submission() { };
        ...
        /// </summary>
        [Fact]
        public async Task IV_40_Submission_BLTVR_Valid()
        {
            var rulesManagerMock = new Mock<IRulesManager>();
            var instrumentationManagerMock = new Mock<ILookupManager>().Object;
            var submission = new Submission() { };
        ...
        /// </summary>
        [Fact]
        public async Task IV_40_Submission_InstrumentationCode_InValid()
        {
            var rulesManagerMock = new Mock<IRulesManager>();
        ...
        /// </summary>
        [Fact]
        public async Task IV_40_Submission_InstrumentationCode_Valid()
        {
            var rulesManagerMock = new Mock<IRulesManager>();
            var instrumentationManagerMock = new Mock<ILookupManager>();
            var submission = new Submission() { };
