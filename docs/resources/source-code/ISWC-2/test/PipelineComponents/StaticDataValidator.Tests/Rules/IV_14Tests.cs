...
namespace SpanishPoint.Azure.Iswc.PipelineComponents.StaticDataValidator.Tests.Rules
{
    ...
    public class IV_14Tests : TestBase
    {
        ...
        /// </summary>
        [Fact]
        public async Task IV_14_Submission_PreferredIswc_InValid()
        {
        ...
        /// </summary>
        [Fact]
        public async Task IV_14_Submission_Iswc_InValid()
        {
            var submission = new Submission() { Model = new SubmissionModel() };
        ...
        /// </summary>
        [Fact]
        public async Task IV_14_Submission_Valid()
        {
            var submission = new Submission() { Model = new SubmissionModel() };
        ...
        /// </summary>
        [Fact]
        public async Task IV_14_No_Preferred_ISWC_CUR_Submission_Valid()
        {
