...
namespace SpanishPoint.Azure.Iswc.PipelineComponents.LookupDataValidator.Tests.Rules
{
    ...
    public class IV_24Tests : TestBase
    {
        ...
        /// </summary>
        [Fact]
        public async Task IV_24_Submission_TrueParam_Valid()
        {
        ...
        /// </summary>
        [Fact]
        public async Task IV_24_Submission_TrueParam_AllPublicDomainCreators_InValid()
        {
            var submission = new Submission() { Model = new SubmissionModel() };
            var rulesManagerMock = new Mock<IRulesManager>();
            var interestedPartyManagerMock = new Mock<IInterestedPartyManager>();
        ...
        /// </summary>
        [Fact]
        public async Task IV_24_Submission_TrueParam_AllPublicDomainCreators_Valid()
        {
            var submission = new Submission() { Model = new SubmissionModel() };
            var rulesManagerMock = new Mock<IRulesManager>();
            var interestedPartyManagerMock = new Mock<IInterestedPartyManager>();
        ...
        /// </summary>
        [Fact]
        public async Task IV_24_Submission_FalseParam_Valid()
        {
            var submission = new Submission() { Model = new SubmissionModel() };
            var rulesManagerMock = new Mock<IRulesManager>();
            var interestedPartyManagerMock = new Mock<IInterestedPartyManager>();
        ...
        /// </summary>
        [Fact]
        public async Task IV_24_Submission_FalseParam_InValid()
        {
            var submission = new Submission() { Model = new SubmissionModel() };
            var rulesManagerMock = new Mock<IRulesManager>();
            var interestedPartyManagerMock = new Mock<IInterestedPartyManager>();
