...
namespace SpanishPoint.Azure.Iswc.PipelineComponents.MetadataStandardizationValidator.Tests.Rules
{
    ...
    public class MD_18Tests : TestBase
    {
        ...
        /// </summary>
        [Fact]
        public async Task MD_18_Submission_Invalid()
        {
        ...
        /// </summary>
        [Fact]
        public async Task MD_18_Submission_Valid_CheckSum_Does_Not_Exist()
        {
            var rulesManagerMock = new Mock<IRulesManager>();
            var workManagerMock = new Mock<IWorkManager>();
            var agencyManagerMock = new Mock<IAgencyManager>();
        ...
        /// </summary>
        [Fact]
        public async Task MD_18_Submission_Valid_CheckSum_Hash_Values_Are_Different()
        {
            var rulesManagerMock = new Mock<IRulesManager>();
            var workManagerMock = new Mock<IWorkManager>();
            var agencyManagerMock = new Mock<IAgencyManager>();
        ...
        /// </summary>
        [Fact]
        public async Task MD_18_AllPossibleValues()
        {
            var rulesManagerMock = new Mock<IRulesManager>();
            var workManagerMock = new Mock<IWorkManager>();
            var agencyManagerMock = new Mock<IAgencyManager>();
        ...
        /// </summary>
        [Fact]
        public async Task MD_18_Submission_Valid_Disabled_By_Agency()
        {
            var rulesManagerMock = new Mock<IRulesManager>();
            var workManagerMock = new Mock<IWorkManager>();
            var agencyManagerMock = new Mock<IAgencyManager>();
        ...
        /// </summary>
        [Fact]
        public async Task MD_18_SetToFalse()
        {
            var rulesManagerMock = new Mock<IRulesManager>();
            var workManagerMock = new Mock<IWorkManager>();
            var agencyManagerMock = new Mock<IAgencyManager>();
        ...
        /// </summary>
        [Fact]
        public async Task MD_18_PreviewDisambiguationTrue()
        {
            var rulesManagerMock = new Mock<IRulesManager>();
            var workManagerMock = new Mock<IWorkManager>();
            var agencyManagerMock = new Mock<IAgencyManager>();
