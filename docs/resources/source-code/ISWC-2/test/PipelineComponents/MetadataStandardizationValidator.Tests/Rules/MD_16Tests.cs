...
namespace SpanishPoint.Azure.Iswc.PipelineComponents.MetadataStandardizationValidator.Tests.Rules
{
    ...
    public class MD_16Tests : TestBase
    {
        ...
        /// </summary>
        [Fact]
        public async Task MD_16_Submission_TrueParam_NewIpBaseNumber()
        {
        ...
        /// </summary>
        [Fact]
        public async Task MD_16_Submission_FalseParam_InValid()
        {
            var submission = new Submission() { Model = new SubmissionModel() };
            var interestedPartyManagerMock = new Mock<IInterestedPartyManager>();
            var rulesManagerMock = new Mock<IRulesManager>();
        ...
        /// </summary>
        [Fact]
        public async Task MD_16_Submission_FalseParam_IswcEligibleNewIpBaseNumber()
        {
            var submission = new Submission() { Model = new SubmissionModel() };
            var interestedPartyManagerMock = new Mock<IInterestedPartyManager>();
            var rulesManagerMock = new Mock<IRulesManager>();
        ...
        /// </summary>
        [Fact]
        public async Task MD_16_Submission_FalseParam_NotStatus3_Valid()
        {
            var submission = new Submission() { Model = new SubmissionModel() };
            var interestedPartyManagerMock = new Mock<IInterestedPartyManager>();
            var rulesManagerMock = new Mock<IRulesManager>();
        ...
        /// </summary>
        [Fact]
        public async Task MD_16_Submission_FalseParam_ISWCIneligible_NewIpBaseNumber()
        {
            var submission = new Submission() { Model = new SubmissionModel() };
            var interestedPartyManagerMock = new Mock<IInterestedPartyManager>();
            var rulesManagerMock = new Mock<IRulesManager>();
        ...
        /// </summary>
        [Fact]
        public async Task MD_16_Submission_TrueParam_CIQ_Transaction()
        {
            var submission = new Submission() { Model = new SubmissionModel() };
            var interestedPartyManagerMock = new Mock<IInterestedPartyManager>();
            var rulesManagerMock = new Mock<IRulesManager>();
        ...
        /// </summary>
        [Fact]
        public async Task MD_16_Submission_FalseParam_NewIpBaseNumber()
        {
            var submission = new Submission() { Model = new SubmissionModel() };
            var interestedPartyManagerMock = new Mock<IInterestedPartyManager>();
            var rulesManagerMock = new Mock<IRulesManager>();
