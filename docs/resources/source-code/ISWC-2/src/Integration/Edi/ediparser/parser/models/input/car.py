...
class CAR(TransactionMixin, InputTransaction):
    ...
    def get_body(self):
        body = {
            ...
            'workcode': self.get_field('AgencyWorkCode'),
            'category': 'DOM',
            'disambiguation': False,
            'originalTitle': self.get_field('WorkTitle'),
        ...
        if self.header['EdiFileVersion'] == EdiFileVersion.THREE:
            ...
            body['disambiguation'] = self.get_field(
                'Disambiguation') == 'T'
