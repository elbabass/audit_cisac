...
{
    internal class MatchingForIswcEligibleSubmitter : IInitialMatchingComponent
    {
        private readonly IMatchingManager matchingManager;

        public MatchingForIswcEligibleSubmitter(IMatchingManager matchingManager)
        {
            this.matchingManager = matchingManager;
        }

        public string Identifier => nameof(MatchingForIswcEligibleSubmitter);
