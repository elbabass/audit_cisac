...
namespace SpanishPoint.Azure.Iswc.Api.Publisher.V1.Controllers
{
    internal class SearchController : BaseController, IISWC_SearchController
    {
        ...
        public async Task<ActionResult<ICollection<IPContextSearchResponse>>> ContextSearchAsync(IPContextSearchModel body)
        {
            ...
            return Ok(mapper.Map<List<IPContextSearchResponse>>(response));
        }
